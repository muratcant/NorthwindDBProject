...
namespace NorthwindDBProject.Business.Abstract
{
    public interface ITerritoryService
    {
        ...
        /// <returns> </returns>
        List<Territory> GetAll(Expression<Func<Territory, bool>> filter = null);
        Territory Get(Expression<Func<Territory, bool>> filter);
        Territory GetById(int id);
        void Add(Territory entity);
        void Update(Territory entity);
        void Delete(Territory entity, bool realDelete = false);
        void Delete(int id);
        void AddRange(List<Territory> entities);
        void RemoveRange(List<Territory> entities);
        void RemoveRange(Expression<Func<Territory, bool>> filter = null);
        #endregion
        ...
        /// <returns></returns>
        Task DeleteAsync(Territory entity, bool realDelete = false);
        /// <summary>
        /// Filtreme yaptıktan sonra gönderilen tipe ait bir listeyi asenkron olarak döndürür.
        /// </summary>
        /// <param name="filter"></param>
        /// <returns></returns>
        Task<List<Territory>> GetAllAsync(Expression<Func<Territory, bool>> filter = null);
        /// <summary>
        ...
        /// <param name="filter"></param>
        /// <returns></returns>
        Task<int> CountAllAsync(Expression<Func<Territory, bool>> filter = null);
        /// <summary>
        /// Gönderilen listeyi bulk halinde asenkron olarak veritabanına ekler (insert into)
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
        Task AddRangeAsync(List<Territory> entities);
        /// <summary>
        /// Gönderilen Listeyi bulk halinde asenkron olarak veri tabanından siler
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
        Task RemoveRangeAsync(List<Territory> entities);
        Task RemoveRangeAsync(Expression<Func<Territory, bool>> filter = null);
        #endregion
