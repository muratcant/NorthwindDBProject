...
namespace NorthwindDBProject.Business.Abstract
{
    public interface ICustomerCustomerDemoService
    {
        ...
        /// <returns> </returns>
        List<CustomerCustomerDemo> GetAll(Expression<Func<CustomerCustomerDemo, bool>> filter = null);
        CustomerCustomerDemo Get(Expression<Func<CustomerCustomerDemo, bool>> filter);
        CustomerCustomerDemo GetById(int id);
        void Add(CustomerCustomerDemo entity);
        void Update(CustomerCustomerDemo entity);
        void Delete(CustomerCustomerDemo entity, bool realDelete = false);
        void Delete(int id);
        void AddRange(List<CustomerCustomerDemo> entities);
        void RemoveRange(List<CustomerCustomerDemo> entities);
        void RemoveRange(Expression<Func<CustomerCustomerDemo, bool>> filter = null);
        #endregion
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        Task<CustomerCustomerDemo> GetByIdAsync(int id);
        /// <summary>
        /// Asenkron olarak filtreleme yaptıktan sonra ilk Entity'yi döndürür.
        /// </summary>
        /// <param name="filter"></param>
        /// <returns></returns>
        Task<CustomerCustomerDemo> GetAsync(Expression<Func<CustomerCustomerDemo, bool>> filter);
        /// <summary>
        /// Gönderilen Entity yi asenkron olarak veritabanına ekler (insert)
        /// </summary>
        /// <param name="entity"></param>
        /// <returns></returns>
        Task AddAsync(CustomerCustomerDemo entity);
        /// <summary>
        /// Gönderilen Entity'yi asenkron olarak veritabanında günceller (update)
        /// </summary>
        /// <param name="entity"></param>
        /// <returns></returns>
        Task UpdateAsync(CustomerCustomerDemo entity);
        /// <summary>
        ...
        /// <returns></returns>
        Task DeleteAsync(CustomerCustomerDemo entity, bool realDelete = false);
        /// <summary>
        /// Filtreme yaptıktan sonra gönderilen tipe ait bir listeyi asenkron olarak döndürür.
        /// </summary>
        /// <param name="filter"></param>
        /// <returns></returns>
        Task<List<CustomerCustomerDemo>> GetAllAsync(Expression<Func<CustomerCustomerDemo, bool>> filter = null);
        /// <summary>
        ...
        /// <param name="filter"></param>
        /// <returns></returns>
        Task<int> CountAllAsync(Expression<Func<CustomerCustomerDemo, bool>> filter = null);
        /// <summary>
        /// Gönderilen listeyi bulk halinde asenkron olarak veritabanına ekler (insert into)
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
        Task AddRangeAsync(List<CustomerCustomerDemo> entities);
        /// <summary>
        /// Gönderilen Listeyi bulk halinde asenkron olarak veri tabanından siler
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
        Task RemoveRangeAsync(List<CustomerCustomerDemo> entities);
        Task RemoveRangeAsync(Expression<Func<CustomerCustomerDemo, bool>> filter = null);
        #endregion
