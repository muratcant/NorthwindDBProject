...
namespace NorthwindDBProject.Business.Abstract
{
    public interface ISupplierService
    {
        ...
        /// <returns> </returns>
        List<Supplier> GetAll(Expression<Func<Supplier, bool>> filter = null);
        Supplier Get(Expression<Func<Supplier, bool>> filter);
        Supplier GetById(int id);
        void Add(Supplier entity);
        void Update(Supplier entity);
        void Delete(Supplier entity, bool realDelete = false);
        void Delete(int id);
        void AddRange(List<Supplier> entities);
        void RemoveRange(List<Supplier> entities);
        void RemoveRange(Expression<Func<Supplier, bool>> filter = null);
        #endregion
        ...
        /// <returns></returns>
        Task DeleteAsync(Supplier entity, bool realDelete = false);
        /// <summary>
        ...
        /// <param name="filter"></param>
        /// <returns></returns>
        Task<int> CountAllAsync(Expression<Func<Supplier, bool>> filter = null);
        /// <summary>
        /// Gönderilen listeyi bulk halinde asenkron olarak veritabanına ekler (insert into)
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
        Task AddRangeAsync(List<Supplier> entities);
        /// <summary>
        /// Gönderilen Listeyi bulk halinde asenkron olarak veri tabanından siler
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
        Task RemoveRangeAsync(List<Supplier> entities);
        Task RemoveRangeAsync(Expression<Func<Supplier, bool>> filter = null);
        #endregion
